...
import { userService } from "../3-services/index.services";
import { cardscontainerService } from "../3-services/index.services";
...
const handleUser = async (
  ...
  try {
    ...
    if (validatedUserData.isNew === true) {
      ...
      const userData = await cardscontainerService.getCardscontainersByUser(
        validatedUserData
      );
